...
/** checks that the reservation is:
  1 in the future
  2 the day that the restaurant is open
  3 during the restaurant's open hours
*/
...
// use read() to return the data
//with the given reservation id in the request params 
...
// the reservation has a valid status
...
// list reservations for a given date with or without a given phone number 
...
// create a new reservation, and returns it's data from the reservations list 
