...
//search component allow user to llok for the reservation by putting the phone number
...
export default function Search() {
  ...
  //update the state of mobile_number when the user makes any changes
  function handleChange({ target }) {
    setMobileNumber(target.value)
  }

  //make a get request to list all reservations with the number when the 'submit button is clicked
